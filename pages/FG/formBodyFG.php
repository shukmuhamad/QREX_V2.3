      ...
      <form role="form" method ="post" id="InspectionForm">
        ...
        <div class="col-lg-6">
          ...
          <div class="form-group">
            ...
            <input class="form-control" name="BatchNumber" id="BatchNumber" placeholder="Enter Batch Number" required>
            <div id="checkk"></div>
          </div>
          <!-- /.form-group -->
          ...
          <div class="form-group">
            ...
            <div class="radio">
              <label>
              <input type="radio" name="inspection_stage" value="1" onclick="EnableDisableTextBox()" checked>FINISHED GOOD
              </label>
            </div>
            <div class="radio">
              <label>
              <input type="radio" name="inspection_stage" value="0" onclick="EnableDisableTextBox()" >FINISHED GOOD OVERALL (COMBINE SIZE)
              </label>
            </div>
          </div>
          <!-- /.form-group -->
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="number" min="0" name="InspectionCount" id="InspectionCount" placeholder="Enter Inspection Count" onkeyup="checkcount()"  required>
          </div>
          <!-- /.form-group -->
          ...
          <div class="form-group">
            ...
            <input type="number" min="0" class="form-control" name="CartonQuantity" placeholder="Enter Carton Quantity" required>
          </div>
          <!-- /.form-group -->
        ...
        <div class="col-lg-6">
          ...
          <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
            ...
            <tr>
              ...
              <td>
                <input type="datetime-local" class="form-control" name="product_date1" max="<?php echo date('Y-m-d'); ?>" id="product_date1" onkeydown="return false" required style="padding: 0 0 0 8px;">
              </td>
      ...
      <div class="col-lg-12">
        ...
        <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
          ...
          <tr>
            ...
            <td><input class="form-control digit" name="sample_size_apt2" id="sample_size_apt2" placeholder="0" ></td>
        ...
        <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
          ...
          <tr style="text-align: center;">
            ...
            <td><input type="hidden" class="form-control digit" name="Acceptance_minor" value="<?php echo $Record_AQL[0]['AQLValue']; ?>" > <?php echo $Record_AQL[0]['AQLValue']; ?></td>
            <td><input  type="hidden" class="form-control digit" name="Acceptance_major" value="<?php echo $Record_AQL[1]['AQLValue']; ?>" > <?php echo $Record_AQL[1]['AQLValue']; ?></td>
            <td><input type="hidden" class="form-control digit" name="Acceptance_nag" value="<?php echo $Record_AQL[4]['AQLValue']; ?>" > <?php echo $Record_AQL[4]['AQLValue']; ?></td>
            <td><input type="hidden" class="form-control digit" name="Acceptance_nfg" value="<?php echo $Record_AQL[3]['AQLValue']; ?>" > <?php echo $Record_AQL[3]['AQLValue']; ?></td>
            <td><input type="hidden" class="form-control digit" name="Acceptance_holes1" value="<?php echo $Record_AQL[2]['AQLValue']; ?>" > <?php echo $Record_AQL[2]['AQLValue']; ?></td>
