              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="soNumber" class="form-control" placeholder="SO Number">
                  </div>
                  <!-- /.form-group -->

                  <div class="form-group">
                    <label>Item Number</label>
                    <input type="number" name="itemNumber" class="form-control" placeholder="Item Number">
                  </div>
                  <!-- /.form-group -->
                </div>
                <!-- /.col -->
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="lotCount" class="form-control" placeholder="Lot Count">
                  </div>
                  <!-- /.form-group -->

                  <div class="form-group">
                    <label>Pallet Number</label>
                    <input type="number" name="palletNumber" class="form-control" placeholder="Pallet Number">
                  </div>
                  <!-- /.form-group -->
                </div>
                <!-- /.col -->
