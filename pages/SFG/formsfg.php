                ...
                <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control fstdropdown-select" name="GloveSizeCodeLong" required>
                      ...
                      <?php foreach ($fetch as $row){ ?>
                      <option value="<?php echo $row['GloveSizeCodeLong'];?>"><?php echo $row['GloveSizeCodeLong'];}?></option>
                    </select>
                  </div>
                  <!-- /.form-group -->
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="date" name="PackingDate"  onkeydown="return false" required style="padding: 0 0 0 8px;">
                  </div><br>
                  <!-- /.form-group -->
                ...
                <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control fstdropdown-select" name="GloveProductTypeName">
                      ...
                      <?php foreach ($fetch as $row){ ?>
                      <option value="<?php echo $row['GloveProductTypeName'];?>"><?php echo $row['GloveProductTypeName'];}?></option>
                    </select>
                  </div>
                  <!-- /.form-group -->
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control fstdropdown-select" name="GloveCodeLong" required>
                      ...
                      <?php foreach ($fetch as $row){ ?>
                      <option value="<?php echo $row['GloveCodeLong'];?>"><?php echo $row['GloveCodeLong'];}?></option>
                    </select>
                  </div>
                  <!-- /.form-group -->
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control fstdropdown-select" name="GloveColourName" required>
                      ...
                      <?php foreach ($fetch as $row){ ?>
                      <option value="<?php echo $row['GloveColourCode'];?>"><?php echo $row['GloveColourName'];}?></option>
                    </select>
                  </div>
                  <!-- /.form-group -->
              ...
              <div class="col-lg-12">
                ...
                <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td><input class="form-control digit" name="sample_size_vt" id="sample_size" placeholder="0" ></p></td>
                  </tr>
