                                        ...
                                        <div class="modal-body">
                                          ...
                                          <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                                            <tr>
                                              ...
                                              <td><input class="form-control input-sm text-right amount digit" name="DB" placeholder="0" onkeyup="this.value = minmax(this.value, 0, 1000)" Maxlength="5" value="<?php echo $defectResult_pivot['1']; ?>" ></td>
